// Configuração da página de agendamento. É o único arquivo que precisa ser editado.
// Tudo aqui é público (a página fica no GitHub Pages): não coloque senhas nem dados de clientes.
window.LADO_A_LADO = {
  // Endereço do app da web do Google Apps Script (termina em /exec). Veja script-ficha/LEIA-ME.md.
